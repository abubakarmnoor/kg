	...
	for (var q=0;q<items.length;q++) {			
      ...
      if (item.find('.esg-click-to-play-video').length==0) {
			...
			if (prep.data('youtube')!=undefined) {
				...
				// var ytframe = "https://www.youtube.com/embed/"+prep.data('youtube')+"?version=3&enablejsapi=1&html5=1&controls=1&autohide=1&rel=0&showinfo=0";
				var ytframe = "https://www.youtube.com/embed/"+prep.data('youtube')+"?autoplay=1&mute=1&controls=0&showinfo=0&rel=0&loop=1&enablejsapi=1&origin=https%3A%2F%2Fkarmagroup.com&widgetid=1&playlist="+prep.data('youtube');
			...
			if (prep.data('mp4')!=undefined || prep.data('webm')!=undefined || prep.data('ogv')!=undefined) {
			   media.append('<video class="esg-video-frame" controls loop playsinline muted style="position:absolute;top:0px;left:0px;'+videovisible+'" width="'+prep.attr("width")+'" height="'+prep.attr("height")+'" data-origw="'+prep.attr("width")+'" data-origh="'+prep.attr("height")+'"></video');
...
function onPlayerStateChange(event) {
		...
		if (event.data == YT.PlayerState.PLAYING) {
			if(typeof event.target.setPlaybackQuality !== "undefined"){
