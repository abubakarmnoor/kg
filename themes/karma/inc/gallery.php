...
?>
<li>
<a alt="<?php echo $image->alttext; ?>"<?php echo $img_title; ?> class="image_link" href="<?php echo $image->url; ?>">
<div class="gallery_image" style="background:url('<?php echo $image->url; ?>') center; background-size: cover;" alt="<?php echo $image->alttext; ?>"<?php echo $img_title; ?>></div>
</a>
</li>
<?php }?>
	...
	<div class="paging">
		...
		//$query_str = get_option( 'siteurl' ).'/gallery/?';
                $query_str = get_option( 'siteurl' ).'/gallery/'.$image->title.'/?';
