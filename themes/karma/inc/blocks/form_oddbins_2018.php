...
if(isset($_GET['email']) && $_GET['email'] != ""){    
    $pc = str_replace(" ", "%20","ODDBINS 2018");
    ...
    elseif(empty($user->records)){ ?>
        <div id="contained_content" style="<?php echo $margin; ?>">
            <section id="landing-page__form-header" class="section-wrapper">
                ...
                <p>Please contact <a href="mailto:oddbins@karmagroup.com" target="_blank">oddbins@karmagroup.com</a> for assistance.</p>
        ...
        <div id="contained_content" style="<?php echo $margin; ?>">
            ...
            <div class="row">
                <div class="form-group button-wrap">
                    <a href="https://card.karmaclub.com/voucher-oddbins-<?php echo $kcID; ?>.pdf" class="btn bg-gold" style="color: #FFF;padding: 20px;font-size: 16px;font-weight: bold;">DOWNLOAD MY VOUCHER</a>                     
                </div>							
            </div>
        </div>
    <?php } 
        ...
        <div id="contained_content" style="<?php echo $margin; ?>">
            <section id="landing-page__form-header" class="section-wrapper">
                ...
                <p>Please confirm your details below to download your £250 voucher.*</p>
            </section>
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="form-group button-wrap">
                                        ...
                                        <p style="font-size:11px;padding-top:10px;">*Terms & Conditions: Each £250 voucher valid against bookings of minimum 7 consecutive nights at selected Karma resorts – see digital voucher for applicable destinations. Visit <a href="https://karmagroup.com/" target="_blank">www.karmagroup.com</a> for more information on destinations. One voucher per stay. Voucher valid for 1 year from receipt of email. See voucher expiry date at top right of voucher. Vouchers can only be downloaded and used by people aged 18 or over. Booking subject to availability, and blackout dates apply. Advanced reservation is required by contacting to <a href="mailto:oddbins@karmagroup.com">oddbins@karmagroup.com</a> please reference your voucher code when booking. Not to be combined with any other resort offer or promotion. The voucher cannot be exchanged for cash or other equivalent. Voucher is non-transferable and can only be used by the person named on the voucher. Each voucher can only be used once. One voucher per person. Copied or damaged vouchers are invalid. Please bring the voucher with you and present upon your arrival. Please see digital voucher for additional terms and conditions, including applicable destinations and use by date.</p>                                 
                                    </div>							
                                </div>
                    ...
                    $('#frm').validate({
                     ...
                     $('#frm').on('submit',function(e){
                        ...
                        var dataToCloud = {                            
                            ...
                            "collectionEntryPoint": "Oddbins Landing Page",
                        ...
                        checkingPhone(function(){
                           if($("#doNotCall").is(":checked")){
                                if (isvalidate && isValidPhone) {                                               
                                    ...
                                    if(userAge >= 18){	
                                        var urlWarehouse  ='https://karmawarehouse.izenoondemand.com/production/api/karmaclub/group/karmacluboffer.php?first_name=' + firstname + '&last_name=' + lastname + '&phone=' + mobilecode+mobilenumber + '&email=' + email + '&dob=' + dob2 + '&country=' + country + '&postalcode=' + postcode + "&maritalStatus=" + sugarMarital +'&promocode=ODDBINS 2018&data_source=Karma Club Activate&collection_entry_point=Oddbins Landing Page&card_downloaded_c=true&website='+ "<?php echo($_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI']); ?>";
                                        ...
                                        $.ajax({
                                            ...
                                            success: function(data, textStatus, jqXHR){
                                                if(textStatus === "success"){  
                                                    $.ajax({
                                                        type: "POST",
                                                        url: "<?php echo get_karma_api_base_url(); ?>/oddbins-active/<?php echo $user->records[0]->id ?>",
                                                        // url: "http://localhost:8080/oddbins-active/<?php echo $user->records[0]->id ?>",
                                                        data: dataToCloud,
                                                        success: function(data, textStatus, jqXHR) {                                                          
                                                            setTimeout(function(){
                                                                $('#loading').css('display','none');
