...
$('#frm').validate({
 ...
 $('#frm').on('submit',function(e){
    ...
    // $('#mobileNumber').val($('#mobilenumber').val()); //ok
     ...
     var pidval = "<?php echo get_the_ID();?>";
     if (pidval=='9881') { pidval="harratts2"; } else { pidval="harratts"; }
   	 ...
   	 var isvalidate = $('#frm').valid();
	   	if (isvalidate) {
	            ...
	            if (data == '0'){
            	    ...
            	    $.ajax({
		                type: "POST",
		                url: "<?php echo get_karma_api_base_url(); ?>/harrats",
		                data: dataPush,
		                dataType: "json",
