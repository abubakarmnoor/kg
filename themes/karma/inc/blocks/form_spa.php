...
<div id="contained_content" style="<?php echo $margin; ?>">
			...
			<div class="back section2">
			   <div class="col-md-6 col-lg-6 content1">
			      <p>&nbsp;</p>			      
			      <h3>Win a Yoga Facial at Karma Spa In Bali</h3>
			      <p style="font-style:italic;font-family:georgia!important;"> Our beautifully slow sequence will nourish your skin and nurture your mind. It consists of a mind-soothing blend of lymphatic drainage and facial acupressure techniques. Delivered with divine facial oils. Depart feeling more balanced and centered. 
			       </p>
			   </div>
			                  ...
			                  <tbody>
			                     ...
			                     <tr>
			                        ...
			                        <td>
			                           ...
			                           <br>
			                           <center>The expiry date April 30th</center>
			                        </td>
			                     </tr>
			                  </tbody>
			               </table>
...
<script type="text/javascript"> 
   ...
   $('#ksa').on('submit', function(e) {
   	...
   	if (isvalidate) {
   		 ...
   		 $.ajax({
            type: "GET",
            url: "https://karmawarehouse.izenoondemand.com/production/api/sugarapi/emailpromocodelookup-wh.php?email="+$('#email1').val()+"&pc=SPA0418",
            ...
            if (data == '0'){
	           	$.ajax({
		            type: "POST",
		            url: 'https://karmawarehouse.izenoondemand.com/production/api/karmaclub/group/karmacluboffer.php?first_name=' + $('#firstname1').val() + '&last_name=' + $('#lastname1').val() + '&email=' + $('#email1').val() + '&collection_entry_point=SPA0418&website=https://karmagroup.com/yoga-facial-competition&promocode=SPA0418',
		       ...
		       //         	$('.form-style-5').append('Thank you for your entry winners will be contacted via email. #ExperienceKarma');
		                window.location.href = "<?php echo get_site_url(); ?>/thank-you-yoga-facial/";
		                //alert('success');
