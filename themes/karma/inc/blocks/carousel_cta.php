...
foreach ($fields['slides'] as $slide) {
        ...
        if (!empty($link)) {
                //10042 713 10723
                if (get_the_ID() !== 10723) {
                                $html .= '<a class="button_outline" href="' .$link. '" rel="noopener" title="' .$slide['link_text']. '" title="' .$slide['link_text']. '" alt="' .$slide['link_text']. '" style="margin-bottom: 8px;">' .$slide['link_text']. '</a>';
                }
                else{
                        if (preg_match("/#spa-newsletter/i", $link)) {
                                $html .= '<a class="button_outline" href="' .$link. '" rel="noopener" title="' .$slide['link_text']. '" title="' .$slide['link_text']. '" alt="' .$slide['link_text']. '" style="margin-bottom: 8px;" id="spa-newsletter-toggler" data-remodal-target="modal-spa-newsletter">' .$slide['link_text']. '</a>';
                                $isThisSpa = true;
                        }
                        elseif (preg_match("/#happyboosters/i", $link)) {
                                $html .= '<a class="button_outline" href="' .$link. '" rel="noopener" title="' .$slide['link_text']. '" title="' .$slide['link_text']. '" alt="' .$slide['link_text']. '" style="margin-bottom: 8px;" id="happyboosters" data-remodal-target="modal-spa-newsletter">' .$slide['link_text']. '</a>';
                                $isThisSpa = true;
                        }
                        elseif (preg_match("/#yoga/i", $link)) {
                                $html .= '<a class="button_outline" href="' .$link. '" rel="noopener" title="' .$slide['link_text']. '" title="' .$slide['link_text']. '" alt="' .$slide['link_text']. '" style="margin-bottom: 8px;" id="yoga" data-remodal-target="modal-spa-newsletter">' .$slide['link_text']. '</a>';
                                $isThisSpa = true;
                        }
                        elseif (preg_match("/mailto:res@karmaresort.com/i", $link)) {
                                $html .= '<a class="button_outline" href="mailto:res@karmaresort.com" rel="noopener" title="' .$slide['link_text']. '" title="' .$slide['link_text']. '" alt="' .$slide['link_text']. '" style="margin-bottom: 8px;" id="spa-newsletter-toggler" data-remodal-target="modal-spa-newsletter">' .$slide['link_text']. '</a>';
                                $isThisSpa = true;
                        }
                        else{
                                $html .= '<a class="button_outline" href="' .$link. '" rel="noopener" title="' .$slide['link_text']. '" title="' .$slide['link_text']. '" alt="' .$slide['link_text']. '" style="margin-bottom: 8px;">' .$slide['link_text']. '</a>';
