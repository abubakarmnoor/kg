...
<div id="contained_content" style="<?php echo $margin; ?>">
	...
	<section id="landing-page__form-header" class="section-wrapper">
        <p id="landing-page__form-header__title">
            How to Enter ? </p>
        <p>Simply complete the form competition below</p>
    </section>
		...
		<div class="container container-inner">
				...
				<div class="col-xs-12 col-sm-12">
					<div class="col-xs-12 col-sm-6">
						<div class="form-group">
							<input type="text" class="form-control" id="firstName1" placeholder="First Name*" name="field-1427865019-1" required />
						</div>
					</div>
					<div class="col-xs-12 col-sm-6">
						<div class="form-group">
            ...
            <div class="row">
              <div class="col-xs-12 col-sm-12">
                ...
                <div class="col-xs-12 col-sm-2">
						<div class="form-group">
							<input type="text" class="form-control" id="completedby" placeholder="Completed By" name="completedby" />
						</div>
				</div>
           	      <div class="col-xs-12 col-sm-6">
                  	<div class="form-group">
	                  	 <div class="phonewrapper">
	                   	 <div class="phoneMsg"></div>
                      		<input type="text" class="form-control phonenumber2" name="mobilenumber" id="mobilenumber" placeholder="Mobile Number*" />
            ...
            <div class="row">
				<div class="col-xs-12 col-sm-12">
			            <div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<input type="text" class="form-control" id="address1" placeholder="Street Line 1" name="street1"  />
							</div>
						</div>
			            <div class="col-xs-12 col-sm-6">
							<div class="form-group">
								<input type="text" class="form-control" id="address2" placeholder="Street Line 2" name="street2"  />
							</div>
						</div>
				</div>
			</div>
			...
			<div class="row">
  				   <div class="col-xs-12 col-sm-6">
						...
						border-bottom: 1px solid #f00!important;
						    ...
						    <div class="checkbox">
                  <span style="font-size:12px;">*Required.</span><br><br>
						    <span style="font-size:12px;">**Please omit the leading 0 (zero) digit when entering your number.</span><br><br>
                <!--<label>
                    <input name="field-1449560763[]" value="By entering the promotion and applying for my FREE 1 year Karma Club membership, I agree to receive emails and telephone calls from Karma Group. Membership is free for 1 year, and can be cancelled at any time. We will never share your details with 3rd parties." style="vertical-align: text-bottom;" class="" name="field-1449560763[]" id="membership-agree" type="checkbox" checked="true">
                    By entering the promotion and applying for my FREE 1 year Karma Club membership, I agree to receive emails and telephone calls from Karma Group. Membership is free for 1 year, and can be cancelled at any time. We will never share your details with 3rd parties.
                </label>
                <label>
                    <input style="vertical-align: text-bottom;" class="" name="field-1449560763[]" id="agreecode" type="checkbox" value="I agree to receive email communications &amp; information from the Karma Club team" checked=""> I agree to Karma Club <a href="https://karmaclub.com/terms-conditions/" target="_blank" title="terms and conditions">terms and conditions</a>.
                </label>-->
						    </div>
						    </div>
						    </div>
...
<script src="https://intl-tel-input.com/node_modules/intl-tel-input/build/js/intlTelInput.js?1501227254404"></script>
...
$('#field-1451441259-text').bind('input keyup', function(){
    var $this = $(this);
    ...
    $this.data('timer', setTimeout(function(){
      ...
      pcode = $('#field-1451441259-text').val().toUpperCase();
    ...
    function updDob() {
      $('#dateOfBirth').val($('#birthOfMonth').val() + '/' + $('#birthOfDate').val() + '/' + $('#birthOfYear').val());
    }
     ...
     var completed = $('#completedby').val();
   	 ...
   	 var isvalidate = $('#frm').valid();
	   	if (isvalidate) {
	   		 ...
	   		 $.ajax({
	            type: "GET",
	            url: "https://karmawarehouse.izenoondemand.com/production/api/sugarapi/emailpromocodelookup-wh.php?email="+$('#email1').val()+"&pc=harratts",
	            ...
	            if (data == '0'){
            	    ...
            	    var dataPush = {
				        ...
				        'streetLine1': $('#address1').val(),
				        'streetLine2': $('#address2').val(),
				        ...
				        'state': $('#state').val(),
				        'country': $('#country').val(),
				        'collectionEntryPoint': 'harratts',
				        'postCode': $('#postCode').val(),
				        'name_friend1_c': $('#completedby').val()
				    };

            	    $.ajax({
		                type: "POST",
		                url: "https://karmamobileapps.herokuapp.com/harrats",
		                data: dataPush,
		                dataType: "json",
				             ...
				             $.ajax({
					            type: "POST",
					            url: 'https://karmawarehouse.izenoondemand.com/production/api/karmaclub/group/karmacluboffer.php?first_name=' + firstname + '&last_name=' + lastname + '&address=' + address1 + '&email=' + email + '&phone=' + phone + '&dob=' + dob2 + '&city=' + city + '&country=' + country + '&postalcode=' + postcode + '&maritalStatus=' + marital + '&name_of_friend_1_c=' + completed + '&collection_entry_point=harratts&website=https://karmagroup.com/karmaexperience/harratts&promocode=harratts',

					            success: function(data, textStatus, jqXHR) {

					                console.log("Submit success to db karmawarehouse...");
					                // $('#ksa').css('display','none');
					                window.location.href = "<?php echo get_site_url(); ?>/thank-you-harratts/";
					                //alert('success');
					                //btn.prop('disabled', false);
