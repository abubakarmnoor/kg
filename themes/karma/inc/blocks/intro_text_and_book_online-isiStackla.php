		<style>	
				...
				#karma .bvg_popup_container .bvg_popup .close_btn {
					...
					background-image: url('<?php echo get_option( 'home' ); ?>/themes/karma_group_theme/imgs/icons/close-icon-rounded.png');
					float: right;
					cursor: pointer;
...
$html .= '</div><div class="stackla-widget" data-id="'. $stackla_id .'" data-hash="'. $stackla_hash .'" data-ct=""
data-title="Karma Kandara" data-alias="karmagroup.stackla.com" data-ttl="30" style="width: 100%; overflow: hidden;"></div>
...
if(get_the_ID()=='731') { //jika halaman bavaria - EN ?>
