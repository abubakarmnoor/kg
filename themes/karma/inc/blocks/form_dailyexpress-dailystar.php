			...
			<div class="row">
  				   <div class="col-xs-12 col-sm-6">
						...
						border-bottom: 1px solid #f00!important;
                            ...
                            <span style="font-size:13px;"><a href="<?php echo get_site_url(); ?>/terms-conditions-daily-express-daily-star/" target="_blank">Term & Conditions</a></span><br><br>
						...
						<div class="row">
							<div class="form-group button-wrap">
								<button id="submitbookingbutton" type="submit" class="btn bg-gold">Join Now</button>	&nbsp; 
     ...
     var completed = $('#completedby').val();
   	 ...
   	 var isvalidate = $('#frm').valid();
	   	if (isvalidate) {
	   		 ...
	   		 $.ajax({
	            type: "GET",
	            url: "https://karmawarehouse.izenoondemand.com/production/api/sugarapi/emailpromocodelookup-wh.php?email="+$('#email1').val()+"&pc=dailyexpress_dailystar",
	            ...
	            if (data == '0'){
            	    ...
            	    var dataPush = {
				        ...
				        'state': $('#state').val(),
				        'country': $('#country').val(),
				        'collectionEntryPoint': 'dailyexpress_dailystar',
