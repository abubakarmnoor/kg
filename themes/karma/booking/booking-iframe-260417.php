...
$data['karmajimbaran'] = array(
					'url_1' => 'https://www.thebookingbutton.co.uk/properties/kjimbarandirect?promotion_code=karmaclubrate',
					'url_2' => 'https://www.thebookingbutton.co.uk/properties/kjimbarandirect',
...
$data['karmakandara'] = array(
					'url_1' => 'https://www.thebookingbutton.com.au/karmagroup/properties/karmakandaradirect?promotion_code=karmaclubrate&check_in_date='. $check_in_date .'&check_out_date='. $check_out_date,
...
$data['karmarottnest'] = array(
					'url_1' => 'https://www.thebookingbutton.co.uk/properties/karmarottnestdirect?promotion_code=karmaclubrate',
					'url_2' => 'https://www.thebookingbutton.co.uk/properties/karmarottnestdirect',
...
<style type="text/css">
	iframe{
		...
		margin-bottom: <?php echo $data[$key]['iframe_marginbottom'] ?>px;
				...
				<div id="tabs">
					...
					<ul id="tabs_title">	
						<li data-rel="1" class="active">
							...
							<div class="left"><span>
								<!-- Karma Club Membe Rate Book Now and Join for FREE - No Hidden Fee -->
						...
						<li data-rel="2">
							...
							<div class="left"><span>
								<b>Standard Rate</b><br />
								<!-- Book right here & enjoy the lowest and most flexible rate you'll find online! -->
							</span></div>
						</li>				
					</ul>
					...
					<ul id="tabs_content">	
						...
						<li data-rel="2">
							...
							<div class="inner" style="overflow-y: hidden;">
								<iframe src="<?php echo $data[$key]['url_2'] ?>" width="100%" height="900" id="iframe2"></iframe>
							</div>
						</li>
					</ul>
    	...
    	/////////////DATEPICKER
    		...
    		$('form').submit(function(){
    				...
    				//}else{
						...
						var url_1 = '<?php echo $data[$key]['url_2'] ?>' + '?check_in_date='+ check_in_date_2 +'&check_out_date='+ check_out_date_2 + n_number_adults + n_number_children + n_number_infants + n_promotion_code;
						//$('#iframe1').show();
						$('#iframe1').attr('src', url_1);	


						var url_2 = '<?php echo $data[$key]['url_2'] ?>' + '?check_in_date='+ check_in_date_2 +'&check_out_date='+ check_out_date_2 + n_number_adults + n_number_children + n_number_infants;
						//$('#iframe2').show();
