...
#newbookingbar label[for="bookingDevice"],
#newbookingbar .subyeartitle{
	display: none;
}
#newbookingbar #submitButton span{
    padding: 0!important;
    height: auto!important;
    line-height: 20px!important;
    margin-top: 6px!important;
}
#newbookingbar #enterCode{
	padding: 0!important;
}
#newbookingbar.bookingMask{
	width: 715px;
	padding-right: 0!important;
	margin-left: -2px !important;
}
#newbookingbar.bookingMask ul{
	padding-left: 0!important;
}
#newbookingbar.bookingMask li{
	color: #90704a!important;
	font-size: 12px;
	padding-top: 1px;
	padding-bottom: 1px;
}
#newbookingbar.bookingMask .formselect .content .sub {
    margin-left: 10px;
    cursor: pointer;
}
#newbookingbar.bookingMask .formselect .content .sub.selected {
	color: #fff!important;
}
#newbookingbar.bookingMask button span{
	margin-left: 2px!important;
}
