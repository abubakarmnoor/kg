 ...
 */
 ...
 ?>
<style type="text/css">
.bvg_popup_container{display:none;position:fixed;width:100%;height:100%;z-index:998;top:0;left:0;color:#fff;background-color:rgba(51,51,51,.85)}.bvg_popup{width:90%;max-width:600px;height:auto;position:fixed;z-index:999;top:calc(50vh - 310px);left:calc(50% - 300px);color:#fff;background:#1b1b1b;padding:25px;display:none}.bvg_popup .cf .close_btn{height:25px;width:25px;background-size:contain;background-image:url(https://karmagroup.com/themes/karma_group_theme/imgs/icons/close-icon-rounded.png);float:right;cursor:pointer;display:inline-block;vertical-align:middle}
</style>
            ...
            <div class="upper_footer">
                <div class="container cf">
                    ...
                    <div class="col one left half">
                        ...
                        <h3><a href="<?php echo get_option( 'home' ); ?>/exclusive-offers/" title="<?php echo $language[$lang]['menu_exclusive_offers']; ?>"><?php echo $language[$lang]['menu_exclusive_offers']; ?></a></h3>
                        <h3><a href="<?php echo get_option( 'home' ); ?>/sitemap/" title="Sitemap">Sitemap</a></h3>
                        ...
                        <?php if (get_the_id()=='8291' || get_the_id()=='914') { echo '<h3><a href="https://karmagroup.com/find-destination/karma-retreats/karma-st-martins/terms-and-conditions/" title="Karma St. Martin\'s Terms and Conditions">Terms and Conditions</a></h3>'; } ?>
			<?php if (get_the_id()=='8304' || get_the_id()=='731') { echo '<h3><a href="https://karmagroup.com/find-destination/karma-resorts/karma-bavaria/terms-and-conditions/" title="Karma Bavaria Terms and Conditions">Terms and Conditions</a></h3>'; } ?>
                 ...
                 <li><a href="<?php echo get_option( 'home' ); ?>/eventcalendar" title="<?php echo $language[$lang]['menu_eventcalendar']; ?>"><?php echo $language[$lang]['menu_eventcalendar']; ?></a></li>
                    ...
                    <div class="col four left">
                        ...
                        <!-- <li class="app_download_btn"><a href="https://itunes.apple.com/us/app/karma-resorts/id602469035?mt=8" target="_blank"><img src="<?php //echo get_stylesheet_directory_uri();?>/imgs/app-store-btn.png" alt=""></a></li> -->
                        <!-- <li class="app_download_btn"><a href="https://play.google.com/store/apps/details?id=hr.apps.n52477719&hl=en" target="_blank"><img src="<?php //echo get_stylesheet_directory_uri();?>/imgs/google-play-btn.png" alt=""></a></li> -->
                    </div><!-- .col -->
...
<!-- <span>close</span>       -->
<p><a href="https://karmagroup.com/wp-content/uploads/2017/04/Karma-Spa-Bavaria-Menu-English.pdf" target="_blank" rel="noopener">Download English Version</a></p>
<p><a href="https://karmagroup.com/wp-content/uploads/2017/04/Karma-Spa-Bavaria-Menu-German.pdf" target="_blank" rel="noopener">Download Germany Version</a></p>
</div></div>
<!----END POPUP KARMA SPA BAVARIA MENU-->

<!-- <div id="right_floating_btn"></div> -->
<div id="right_floating_content"><a href="https://karmaclub.com/join?promocode=DIRECT"><img src="wp-content/plugins/nextgen-gallery/products/photocrati_nextgen/modules/attach_to_post/static/spinner.gif" data-src="<?php echo get_option( 'home' ); ?>/wp-content/themes/karma/imgs/right_floating_banner.png?a01" alt="floating"  ></a></div>
...
<script type="text/javascript">
    ...
    <style type="text/css">
#right_floating_btn{width:130px;height:130px;display:table;position:fixed;top:40%;right:-25px;z-index:9999;cursor:pointer;border-radius:50%;overflow:hidden;background-size:130px 130px!important;background:url(<?php echo get_option('home');?>/wp-content/themes/karma/imgs/right_floating_button.png) no-repeat;opacity:.8;transition:all 0.3s ease;box-shadow:0 0 30px rgba(0,0,0,.3)}#right_floating_btn.active,#right_floating_btn:hover{opacity:1;right:-25px;top:calc(40% - 5px);width:140px;height:140px;background-size:140px 140px!important}#right_floating_btn.mobile{width:90px;height:90px;right:-15px;background-size:95px 95px!important;background-position:-2.4px -2.4px;bottom:10px!important;top:auto}#right_floating_content{display:table;position:fixed;top:calc(40% - 15px);right:5px;z-index:9998;cursor:pointer;overflow:hidden;display:none}#right_floating_content.mobile{top:auto;bottom:20px}#right_floating_content.mobile img{height:67px}#leftstickymenu{background:url(<?php echo get_option('home');?>/wp-content/themes/karma/imgs/sticky_buttons.png) no-repeat;background-size:100% 100%;width:130px;height:130px;display:table;position:fixed;bottom:87px;left:87px;display:none;z-index:9999;cursor:pointer;border-radius:50%;overflow:hidden;opacity:.85;transition:all 0.3s ease;box-shadow:0 0 30px rgba(0,0,0,.3)}#leftstickymenu:hover,#leftstickymenu.active{opacity:1}#leftstickymenu .booking{width:100%;height:70px;display:table;float:left;margin-top:8px}#leftstickymenu .chat{width:50%;height:45px;display:table;float:left}#leftstickymenu .email{width:50%;height:45px;display:table;float:left}.leftstickymenu_booking .lpg{left:40px;bottom:10px;display:none}.leftstickymenu_booking{position:fixed!important;bottom:105px!important;left:194px!important;z-index:999;border:5px solid #fff;height:95px;display:none;width:0}.leftstickymenu_booking .deviceCover{margin-left:20px}.leftstickymenu_booking #submitButton{margin:0!important}.leftstickymenu_booking.bookingMask .form label{margin-bottom:3px}.leftstickymenu_booking.stickybottom .form fieldset{margin-top:-4px!important}.leftstickymenu_booking.stickybottom .subyeartitle{display:table;margin-top:5px}.leftstickymenu_booking.active{display:block}.leftstickymenu_booking.inactive{display:hide}.leftstickymenu_booking.done{width:766px!important}.stickybottom{position:fixed!important;bottom:-40px!important;left:calc(50% - 215px)!important;z-index:999}.stickybottom.bookingMask .form label{margin-bottom:3px}.bookingMask.stickybottom .form fieldset{margin-top:-4px!important}.bookingMask.stickybottom .subyeartitle{display:table;margin-top:5px}
    
#mobile_booking_intro_wrapper{background-color:#101820;font-size:14px;padding:2px 20px 5px;color:#fff!important}.home #mobile_booking_intro_wrapper{display:none}#mobile_booking_intro_wrapper h2{margin-top:15px}#mobile_booking_intro_wrapper .georgia_font{color:#fff!important;padding:0!important}#mobile_booking_intro_wrapper .white_button{display:none}#mobile_booking_intro_wrapper .row{display:table}#mobile_booking_intro_wrapper img{margin:15px 15px 0 0!important}#mobile_booking_intro_wrapper .best_value_btn{margin:0 0 10px!important;width:100%!important}.bookingMask.active_in_mobile{display:table!important}.bookingMask.inactive_in_mobile{display:none!important}@media (max-width:768px){.home #open_destination_mobile_wrapper,.open_booknow_mobile{display:block!important}.home .open_booknow_mobile{display:none!important}}@media (max-width:414px){.bvg_popup .block2{width:100%;float:none}}
</style> 
    <script>
        (function() {
