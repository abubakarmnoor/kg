...
<div class="bvg_popup_container"></div>
    <div class="bvg_popup">
		...
		<p>For guests travelling to Karma Bavaria, in Schliersee, during the
		northern hemisphere's summer and autumn months up to and including the
		end of November 2017:</p>
		
		<p>Major road construction works are taking place on all Bavarian
		motorways in both directions, especially along the A9 from Nürnberg to
		Munich, the A99 from FJS Airport to the south of Munich, and the A8
		from Munich to Salzburg, Austria.</p>
		
		<p>We advise guests to allow for slower than normal travel times by car<br>
		(approx 2-3 hours one way) from FJS Airport to Schliersee, or where
		possible to take one of the many regular train services from Munich
		Hbf station directly to Schliersee - a total travel time of 52
		minutes.</p>
		
		<p>We wish you a pleasant trip!</p>
		
		
		<p>&nbsp;</p>
		<p>Kind regards<br>
		The Karma Bavaria team</p>
		
		<?php }elseif(get_the_ID()=='3143') { ?>
		
		<p><img src="<?php echo get_template_directory_uri(); ?>/imgs/icons/car-icon.png" width="64" /></p>
		<p>Wichtige Information für unsere Gäste!</p>
		
		<p>Bitte, nehmen Sie zur Kenntnis, dass während der Sommermonate bis
		Ende November auf allen Bayerischen Autobahnen große Umbauarbeiten
		stattfinden, ganz besonders auf der A9 (Nürnberg-München),
		A99 (Flughafen München zum Süden von München) und A8 ( München-Salzburg).
		Bitte, rechnen Sie mit längeren Fahrzeiten sowohl bei der Anreise wie
		auch Abreise.</p>
		
		<p>&nbsp;</p>
		<p>Wir wünschen Ihnen eine gute Fahrt!<br>
		...
		<p class="content3"><img src="<?php echo get_option( 'home' ).'/wp-content/uploads/images-bvg/hidden.jpg'; ?>" width="58" height="43">Many online travel sites charge extra fees for online bookings. We guarantee 5% lower than others.</p>
		</div>
		<div class="block2">
		<p class="content2">EXCLUSIVE OFFERS</p>
		<p class="content3"><img src="<?php echo get_option( 'home' ).'/wp-content/uploads/images-bvg/exclusive-offer.jpg'; ?>" width="58" height="43">Only our sites offer elite level hotel
		benefits and special offers for Karma
		Resorts Preferred Guest® members.</p>
		</div>
		<div class="block2">    
		<p class="content2">BEST HOTEL INFORMATION</p>
		<p class="content3"><img src="<?php echo get_option( 'home' ).'/wp-content/uploads/images-bvg/best-hotel-information.jpg'; ?>" width="58" height="43">Get the most robust information about
		our hotels right on our sites.</p>
		</div>
		<div class="block2">    
		<p class="content2">CALL CENTER</p>
		<p class="content3"><img src="<?php echo get_option( 'home' ).'/wp-content/uploads/images-bvg/call-center.jpg'; ?>" width="58" height="43">To speak with a Karma Resorts expert,
...
<?php if(1==2){ //if(get_the_ID()=='731' || get_the_ID()=='3143' && 1==2) { ?>
<script>
...
<div id="floating_image_link"><a href="https://karmaclub.com/join?promocode=DIRECT"><img src="<?php echo get_template_directory_uri(); ?>/imgs/floating_image_link.png" /></a></div>
