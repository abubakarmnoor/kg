<?php
/**
 * Template Name: Booking Iframe Sanctum Tes
 */
?>
...
<div id="wrapper">
		...
		<section id="header">
			<div class="row innerBAK top">
				...
				<div id="join" class="right"><a href="http://karmasanctumclub.com/join.php"><img src="<?php echo get_template_directory_uri(); ?>/booking-iframe/images/sanctum_joinnow.jpg" /></a></div>
			</div>
