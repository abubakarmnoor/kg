...
$(document).ready(function() {
    ...
    function validate(returned_data) 
    {
        ...
        else if(returned_data['success'] == true)
        {
            ...
            //$(".enquiry_form_container #contact_form").append("<div class=\"success_message\" style=\"text-align:center;\"><p>" + success_message +' '+ $('#resort_choice').val()  + "</p></div>");
            //$(".enquiry_form_container #contact_form form").remove();
            //$('.enquiry_form_container').delay(2500).fadeOut();
            window.location.href = "https://karmagroup.com/reservation/index.php?propertyid="+ $('#resort_choice').val();
