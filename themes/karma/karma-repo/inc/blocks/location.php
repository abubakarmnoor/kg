<?php
   ...
   if (isset($fields['gallery'][0]['ngg_id'])) {
                     ...
                     <div class="upper">
                           ...
                           .gds > a{
                              ...
                              display: table;
                                 ...
                                 <div class="gds">
                                          ...
                                          <?php switch (karma_getResortType($post)) {
                                             case 'Karma Resort':
                        ...
                        <div class="lower">
                           <div class="left">
                              ...
                              <h4 class="resort_phone">Reservations (Indonesia): <br /> <?php echo nl2br($fields['reservations_indo']); ?></h4>
                              <?php }  ?>
                              <?php if($fields['reservations_oz']!='' ) { ?>
                              <h4 class="resort_phone">Reservations (Australia): <br /> <?php echo nl2br($fields['reservations_oz']); ?></h4>
                              <?php } ?>
                              <?php if($fields['reservations_france']!='' ) { ?>
                              <h4 class="resort_phone">Reservations (France): <br /><?php echo nl2br($fields['reservations_france']); ?></h4>
                              <?php } ?>
                              <?php if($fields['reservations_german']!='' ) { ?>
                              <h4 class="resort_phone">Reservations (Germany):<br /> <?php echo nl2br($fields['reservations_german']); ?></h4>
                              <?php } ?>
                              <?php if($fields['reservations_uk']!='' ) { ?>
                              <h4 class="resort_phone">Reservations (UK): <br /><?php echo nl2br($fields['reservations_uk']); ?></h4>
                              <?php } ?>
							  <?php if($fields['reservations_singapore']!='' ) { ?>
                              <h4 class="resort_phone">Reservations (Singapore): <br /><?php echo nl2br($fields['reservations_singapore']); ?></h4>
                              <?php } ?>
                              <?php if($fields['telephone_number']!='' ) { ?>
                              <h4 class="resort_phone">Resort Direct Dial: <br /><?php echo nl2br($fields['telephone_number']); ?></h4>
                              <?php } ?>
                              <?php if($fields['resort_email']!='' ) { ?>
                              <h4 class="resort_phone">Email: <?php echo nl2br($fields['resort_email']); ?></h4>
                              <?php } ?>
                           </div>
<!--                            <div class="right">
                              ...
                              <div class="left">
                                 <div class="gallery">
                                       ...
                                       <ul class="slides">
                                          ...
                                          <li>
                                             <a class="image_link" href="<?php echo $image->url; ?>" title="<?php echo $image->alttext; ?>" alt="<?php echo $image->alttext; ?>">
                                                <div class="gallery_image" title="<?php echo $image->alttext; ?>" style="background:url(<?php echo get_option( 'home' ) . $image->url; ?>) center; background-size: cover;"></div>
                                             </a>
                                             <div class="gallery_info">
                                                <div class="gallery_counter"><?php echo $counter . "/" . count($gallery_images); ?></div>
                                    ...
                                    <div id="gallery_thumb_controls2">
                                       <ul class="slides">
                                          <?php 
                                             foreach($gallery_images as $image) 
                                             {
                                             echo '<li><div class="gallery_thumb_icon" style="background:url(' . get_option( 'home' ) . $image->url . ') center; background-size: cover;"></div></li>';
                                             } ?>
                                       </ul>
                                    </div>
                                    ...
                                    <?php 
                                       ...
                                       $gid_property_name['13'] = 'royal-candidasa'; //ROYAL CANDIDASA
                                       $gid_property_name['16'] = 'royal-haathi-mahal'; //HAATHI MAHAL / royal-bella-vista
                                       $gid_property_name['18'] = 'royal-jimbaran'; //ROYAL JIMBARAN
                                       $gid_property_name['20'] = 'royal-palms'; //ROYAL PALMS
                                       $gid_property_name['22'] = 'royal-sanur'; //ROYAL SANUR
                                       ...
                                       $link_url = '/gallery/'.$gid_property_name[$gid];
                                       ?>
                                    <a href="<?php  echo $link_url; ?>" title="View All Images"><button class="button_outline gold">View All Images</button></a>
                                    <?php echo (!empty($fields['virtual_tours_url']) ? '<a href="' . $fields['virtual_tours_url'] . '" title="View Virtual Tutorials"><button class="button_outline gold">View Virtual Tour</button></a>' : ''); ?>
                                 </div>
                                 <!-- .gallery --> 
                              </div>
                              <!-- .left --> 
