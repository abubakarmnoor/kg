					...
					<div class="right">
						<div class="slide_controls slide_controls_<?php echo $bID; ?>">
							...
							foreach ($left_slides as $slide) {
								echo '<li><a href="#"><span>&rsaquo; </span>'.$slide['title'].'</a></li>';
							}
							echo '</div>';
						...
						<ul class="slides">
							...
							<li>
								...
								<?php  if (!empty($slide['image'])): ?>
									<div class="right">
										<div class="image" style="background: url('<?php  echo $slide['image']['sizes']['large']; ?>') center;" alt="<?php  echo $slide['title']; ?>"></div>
									</div><!-- .right -->
								<?php  endif; ?>
							</li>
							<?php }?>
