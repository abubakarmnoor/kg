...
<div class="enquiry_form_container">
    <div id="contact_form">
        ...
        <form action="<?php echo $submit_url; ?>" method="post">
            ...
            <select name="resortChoice" class="karma_group">
                ...
                <?php
                    ...
                    foreach ($karmaResorts as $page): ?>
                        <?php if(trim(get_post_meta($page->ID, 'booking_url', 1)) == ''){ $resort_opt .= '<option ' . ($page->ID == $page_id ? 'selected="selected"' : '') . ' value="' . $page->ID . '">'. $page->post_title .' - '. get_post_meta($page->ID, 'resort_location', 1) . '</option>'; $i++;}
                    endforeach; 
                    if($i>0){
                ...
                <?php 
                    ...
                    foreach ($karmaRetreats as $page): ?>
                        <?php if(trim(get_post_meta($page->ID, 'booking_url', 1)) == ''){ $retreat_opt .= '<option ' . ($page->ID == $page_id ? 'selected="selected"' : '') . ' value="' . $page->ID . '">' . $page->post_title .' - '. get_post_meta($page->ID, 'resort_location', 1) . '</option>'; $i++; }
                    endforeach; 
                ...
                <?php 
                    ...
                    foreach ($karmaRoyal as $page): ?>
                        <?php if(trim(get_post_meta($page->ID, 'booking_url', 1)) == ''){ $royal_opt .= '<option ' . ($page->ID == $page_id ? 'selected="selected"' : '') . ' value="' . $page->ID . '">' . $page->post_title .' - '. get_post_meta($page->ID, 'resort_location', 1) . '</option>'; $i++; }
                    endforeach; 
                ...
                <?php 
                    ...
                    foreach ($karmaEstates as $page): ?>
                        <?php if(trim(get_post_meta($page->ID, 'booking_url', 1)) == ''){ $estate_opt .= '<option ' . ($page->ID == $page_id ? 'selected="selected"' : '') . ' value="' . $page->ID . '">' . $page->post_title .' - '. get_post_meta($page->ID, 'resort_location', 1) . '</option>'; $i++; }
                    endforeach; 
            ...
            <?php
                if(isset($_GET['test'])){
                    if($_GET['test'] == 'asdfq3434reqwt234sdxcsdhfgm45ty4sdfgw45tdfg'){
                        echo'<input type="hidden" name="test" value="asdfq3434reqwt234sdxcsdhfgm45ty4sdfgw45tdfg" />';
                    }                    
                }
            ?>            
