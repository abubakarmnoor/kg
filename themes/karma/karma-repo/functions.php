...
function karma_getGalleryImages($gallery_id = false, $pagenum = false) {
	...
	$results = $wpdb->get_results($sql) or die(mysql_error());
	foreach ($results as $result) {
		$result->url = '/wp-content/gallery/'.$result->name.'/'.$result->filename;		
	}
    return $results;
}
...
function karma_enqueue_scripts() {
	...
	$js_uri = $dir. '/js/';
	$css_uri = $dir. '/css/';
	wp_enqueue_style('stylenewcss', $css_uri. 'main.css?a01');
	...
	wp_register_script('bookingbarjs', $dir. '/booking/bookingbar.js', array('jquery'), NULL, true);
	...
	wp_enqueue_script('karmajs', $js_uri. 'karma.js?a001', array('jquery'), '20161215', true);
	wp_register_script('banner_slider', $js_uri. 'blocks/banner_slider.js', array('jquery'), NULL, true);
    ...
    <div id="contact_form">
        ...
        <div role="form" class="wpcf7" id="wpcf7-f458-o1" lang="en-US" dir="ltr">
            ...
            <form id="form-247" action="https://mx9.inboxgateway.com/form-process.php" method="post">
                ...
                <p><span class="wpcf7-form-control-wrap tel"><input type="text" name="field-1427867633" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" id="contactTel" aria-required="true" aria-invalid="false" placeholder="Tel:"/></span></p>
                ...
                <option value="Karma Club Enquiries">Karma Club Enquiries</option>
                </select></span></p>
...
$.ajax({
type: "POST",
url: "https://karmawarehouse.izenoondemand.com/apicollections/kgenquiry.php",
data: "first_name="+first_name+"&last_name="+last_name+"&email="+email+"&phone="+phone+"&enquiry_message="+enquiry_message+"&enquiry_subject="+enquiry_subject+"&enquiry_type="+enquiry_type+"&yoc="+yoc+"&lead_source_description="+lead_source_description,
...
btn.prop(\'disabled\', false);
	                ...
	                $(\'#form-247\').html(\'<p style="color:#ffffff;"><iframe src="https://www.karmagroup.com/tc/tc-thanks.php" width="1" height="1" frameborder="0" scrolling="no" style="display:none;"></iframe><br><strong>Thank you for getting in touch!</strong><br><br><a href="https://www.facebook.com/karmagroupglobal" target="_blank">Like us on Facebook</a> <br> <a href="https://www.karmaclub.com/" target="_blank">Join our Karma Club for a world of Karma</a><br><br></p>\');
